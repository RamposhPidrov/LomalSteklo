...
class Ui_MainWindow(object):
    class dd:
        def __init__(self, centralwidget, verticalLayout, i):
            ...
            self.pushButton2.setStyleSheet("background-image: url(:resourses/images/garbage_red.png);")
            self.pushButton2.setText("")
            self.pushButton2.setObjectName("pushButton2")
            self.pushButton2.setIcon(QtGui.QIcon("resourses/images/garbage_red.png"))
        ...
        class Interface:
            def __init__(self, Frame, layout):
                ...
                self.label_2.setPixmap(QtGui.QPixmap("resourses/images/recRed.png"))
